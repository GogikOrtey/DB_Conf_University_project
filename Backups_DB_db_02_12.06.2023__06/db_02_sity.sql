...
CREATE TABLE `sity` (
  ...
  PRIMARY KEY (`id_sity`),
  CONSTRAINT `sity_ibfk_1` FOREIGN KEY (`id_sity`) REFERENCES `pers_info` (`id_city`)
...
INSERT INTO `sity` VALUES (1,'Москва'),(2,'Казань'),(3,'Санкт-Петербург'),(4,'Екатеринбург'),(5,'Владивосток');
